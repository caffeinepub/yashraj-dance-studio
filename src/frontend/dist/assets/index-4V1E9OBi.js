      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "header",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-24 md:h-32 py-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => scrollTo$2("#hero"),
                    ...
                    NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
                        ...
                        onClick: (e) => {
                          e.preventDefault();
                          setMenuOpen(false);
                          setTimeout(() => scrollTo$2(link.href), 100);
                        },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "footer",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      style: { color: "#a0a0a0" },
                      children: "Pune's vibrant dance and fitness space — designed for all ages and skill levels. Dance, fitness, and wellness in one place."
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mb-4", style: { color: "#666" }, children: [
                    "Founded by",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#e0e0e0", fontWeight: 600 }, children: "Bhakti Gill" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-3", style: { color: "#555" }, children: "Follow us:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: SOCIAL_LINKS.map(({ key, href, label, Icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      href,
                      target: "_blank",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm", style: { color: "#a0a0a0" }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      ...
                      "C-3, Gurumeher Niwas, Lane No. 5, Adarsh Colony, Tingre Nagar, Pune – 411015"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { borderTop: "1px solid #1a1a1a" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#555" }, children: [
                "© ",
                (/* @__PURE__ */ new Date()).getFullYear(),
                " YASHRAJ DANCE STUDIO. All rights reserved."
              ] }) }) })
            ]
          }
        )
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(90deg, transparent, rgba(0,188,212,0.3), rgba(124,58,237,0.3), transparent)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, rgba(0,188,212,0.15), rgba(124,58,237,0.15))",
                    filter: "blur(30px)"
                  }
                }
              ),
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-black font-display gradient-text", children: "4.9 ★" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs mt-0.5", style: { color: "#a0a0a0" }, children: "Rated by 70+ Happy Students" })
                        ]
                      }
                    )
                  ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading mb-4", style: { color: "#ffffff" }, children: [
                "Who We ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Are" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: { color: "#a0a0a0" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Yashraj Dance Studio is a vibrant dance and fitness space in Pune designed for people of all ages and skill levels. Whether you want to learn dance, get fit, or prepare for a special performance, this is a space where you feel comfortable, confident, and inspired." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                      "Founded by",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#e0e0e0" }, children: "Bhakti Gill" }),
                      ", our studio has grown into one of Tingre Nagar's most loved performing arts spaces."
                    ] })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { color: "#a0a0a0" },
                    children: "We believe dance is not just about steps—it's about expression, energy, and transformation. Every session is designed to make you feel stronger, happier, and more connected to yourself."
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: WHY_CHOOSE.map((val) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-20 grid grid-cols-2 md:grid-cols-4 gap-4", children: MILESTONES.map(({ icon: Icon2, label, value, color }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, style: { color } })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#a0a0a0" }, children: label })
              ]
            },
            label
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(90deg, transparent, rgba(124,58,237,0.3), rgba(0,188,212,0.3), transparent)"
            }
          }
        )
      ]
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-16", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading mb-4", style: { color: "#ffffff" }, children: [
              "Ready to Start ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Dancing?" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#a0a0a0" }, children: "Fill out the form below and our team will reach out to schedule a free trial class — no commitment required." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-10 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-5", children: [
              CONTACT_ITEMS.map(({ icon: Icon2, label, values, color, href }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, style: { color } })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      values.map(
                        (v, i) => href && i === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "a",
                          {
                            href,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, rgba(0,188,212,0.08), rgba(124,58,237,0.08))",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", style: { color: "#fff" }, children: "Follow us on Instagram" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#a0a0a0" }, children: "@yashrajdancestudio" })
                    ] })
                  ]
                }
              ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-12 text-center gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 56, style: { color: "#00bcd4" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h3",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#a0a0a0" }, children: "Thank you! Our team will contact you within 24 hours to schedule your free trial class." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-6", style: { color: "#a0a0a0" }, children: "Fill in your details and we'll get back to you within 24 hours." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      errors.name && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#ef4444" }, children: errors.name })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "label",
                      ...
                      errors.phone && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#ef4444" }, children: errors.phone })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    errors.email && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", style: { color: "#ef4444" }, children: errors.email })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "label",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                        ...
                        children: [
                          ...
                          COURSES.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "option",
                            {
                              value: c,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center", style: { color: "#555" }, children: "First trial class is free. No hidden fees. We'll contact you to confirm." })
                ] })
              }
            )
          ] })
...
const FAQS = [
  {
    ...
    answer: "No, beginners are absolutely welcome! Our classes are designed to be beginner-friendly with step-by-step guidance so anyone can start from zero."
  },
  {
    question: "Do you provide trial classes?",
    answer: "Yes, trial sessions are available. You can book a free trial class to experience the studio before committing to a full batch."
  },
  {
    question: "What should I wear?",
    answer: "Comfortable workout or dance clothes are ideal. Loose-fitting attire that allows free movement is recommended. Specific requirements will be communicated for specialized classes."
  },
  {
    question: "Are there separate batches for kids?",
    answer: "Yes, we have dedicated Kids Dance Classes with age-appropriate curriculum for children and teens in a safe, fun environment."
  },
  {
    question: "Do you customize wedding choreography?",
    answer: "Yes, absolutely! Our wedding choreography is fully personalized — we create routines based on your song choices, group size, and event requirements."
  }
];
      ...
      children: [
        ...
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "pt-4", children: item.answer })
          }
        )
      ]
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-xl mx-auto mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "inline-block text-xs font-semibold uppercase tracking-widest px-3 py-1.5 rounded-full mb-5",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#a0a0a0" }, children: "Everything you need to know before joining. Don't see your question? Contact us directly." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto space-y-3", children: FAQS.map((faq, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            FAQAccordionItem,
            {
              item: faq,
              isOpen: openIdx === idx,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-xl mx-auto mb-12", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading mb-4", style: { color: "#ffffff" }, children: [
              "Our ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Facilities" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#a0a0a0" }, children: "Everything you need for a great experience — from the moment you walk in." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5", children: FACILITIES.map(({ emoji, title, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl", role: "img", "aria-hidden": "true", children: emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h3",
                    {
...
function FinalCTASection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "cta", className: "py-20 md:py-28 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 z-0",
        style: {
          background: "linear-gradient(135deg, rgba(0,188,212,0.12) 0%, rgba(124,58,237,0.18) 50%, rgba(0,188,212,0.1) 100%)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          background: "linear-gradient(90deg, transparent, rgba(0,188,212,0.5), rgba(124,58,237,0.5), transparent)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          background: "linear-gradient(90deg, transparent, rgba(124,58,237,0.4), rgba(0,188,212,0.4), transparent)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "h2",
        {
          ...
          children: [
            "Ready to start your",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "dance journey?" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Take the first step — join a free trial class today and discover why students love Yashraj Dance Studio."
        }
      ),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-12", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading mb-4", style: { color: "#ffffff" }, children: [
              "Moments of ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Magic" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#a0a0a0" }, children: "A glimpse into our classes, sessions, and the studio where the magic happens." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-2 mb-10", children: CATEGORIES.map(({ value, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: filtered.map((item, idx) => {
            var _a2;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", style: { color: "#ffffff" }, children: item.caption }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: ((_a2 = CATEGORIES.find((c) => c.value === item.category)) == null ? void 0 : _a2.label) ?? item.category
                          }
                        )
                      ]
                    }
        ...
        active && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "dialog",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl w-full mx-16", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: active.src,
                ...
                active.caption && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0 z-0",
            style: {
              backgroundImage: "url('/assets/generated/hero-dance.dim_1920x1080.jpg')",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(180deg, rgba(10,10,10,0.55) 0%, rgba(10,10,10,0.3) 40%, rgba(10,10,10,0.75) 80%, rgba(10,10,10,1) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-20 container mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h1",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#ffffff", display: "block" }, children: "Move Better." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", style: { display: "block" }, children: "Feel Stronger." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#ffffff", display: "block" }, children: "Dance Freely." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Dance, fitness, and wellness—all in one space. From beginners to performers, we help you grow with confidence."
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: STATS.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs mt-1", style: { color: "#a0a0a0" }, children: stat.label })
              ] }, stat.label))
            }
          )
        ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-xl mx-auto mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "Why Students Love Us"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading mb-4", style: { color: "#ffffff" }, children: [
              "What Makes Us ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Special" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4", children: HIGHLIGHTS.map(({ stat, label, color }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
...
const SERVICES = [
  {
    ...
    description: "Structured dance training covering Bollywood, Freestyle, and Semi-classical basics with choreography-based learning. Best for beginners to intermediate dancers.",
    highlights: [
      "Bollywood & Freestyle",
  ...
  },
  {
    ...
    emoji: "🔥",
    title: "Zumba Fitness",
    description: "High-energy cardio sessions that blend dance with fitness. Burns calories, boosts stamina, and makes working out feel like a party. Best for weight loss & fun workouts.",
    highlights: [
  ...
  },
  {
    ...
    emoji: "🧘",
    title: "Yoga & Wellness",
    description: "Mindful yoga practice to complement your fitness journey. Build flexibility, strength, and find mental calm. Best for mind-body balance.",
    highlights: [
  ...
  },
  {
    ...
    description: "Make your special day unforgettable with personalized wedding choreography. Couple dances, family performances, and Sangeet routines crafted for you.",
    highlights: [
  ...
  },
  {
    ...
    description: "A fun, nurturing dance environment for kids and teens. Learn basic rhythm, movement, and build confidence through age-appropriate choreography.",
    highlights: [
...
const accentMap = {
  ...
  gradient: {
    border: "rgba(124,58,237,0.2)",
    dot: "#00bcd4",
    btnBg: "linear-gradient(135deg, rgba(0,188,212,0.12), rgba(124,58,237,0.12))",
    btnColor: "#00bcd4"
  }
};
const badgeMap = {
...
function ServiceCard({ service }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden", style: { aspectRatio: "16/9" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: service.image,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 p-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5 mb-6", children: service.highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-16", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading mb-4", style: { color: "#ffffff" }, children: [
              "What We ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Offer" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#a0a0a0" }, children: "From energetic Zumba to mindful Yoga, wedding choreography to kids classes—we have something for everyone." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: SERVICES.map((service) => /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceCard, { service }, service.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse 50% 50% at 50% 50%, rgba(0,188,212,0.04) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-14", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading mb-4", style: { color: "#ffffff" }, children: [
              "Our Teaching ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Approach" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#a0a0a0" }, children: "Our teaching method is built around you — making every session approachable, effective, and genuinely enjoyable." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5", children: APPROACH_POINTS.map(({ emoji, title, desc }, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "rounded-2xl p-6 flex flex-col gap-3 transition-smooth",
              style: {
                backgroundColor: "#111111",
                border: idx % 2 === 0 ? "1px solid rgba(0,188,212,0.15)" : "1px solid rgba(124,58,237,0.15)"
              },
              "data-ocid": "approach-card",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", role: "img", "aria-hidden": "true", children: emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
...
const REVIEWS = [
  {
    ...
    comment: "I joined for wedding choreography and it turned out better than I imagined. The steps were simple, elegant, and easy to learn even for beginners. Highly recommend!"
  },
  {
    id: "r2",
    title: "Supportive and hardworking trainer",
    comment: "The trainer is extremely dedicated and makes sure everyone understands the steps. You never feel left out in the class."
  },
  {
    id: "r3",
    title: "Perfect for beginners",
    comment: "I had zero dance experience, but the way everything is taught step-by-step made it super easy to follow. Now I actually enjoy dancing!"
  },
  {
    id: "r4",
    title: "Fun + fitness together",
    comment: "Zumba sessions are full of energy. It doesn't feel like a workout, but you still burn calories and feel great after every class."
  },
  {
    id: "r5",
    title: "Great for kids too",
    comment: "My child attends the classes and absolutely loves them. The environment is friendly and encouraging."
  }
];
function StarRow({ size = 14 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5", children: ["s1", "s2", "s3", "s4", "s5"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size, fill: "#fbbf24", color: "#fbbf24" }, k)) });
}
function ReviewCard({ review }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      onMouseEnter: (e) => {
        e.currentTarget.style.border = "1px solid rgba(0,188,212,0.4)";
        e.currentTarget.style.boxShadow = "0 4px 32px rgba(0,0,0,0.6), 0 0 24px rgba(0,188,212,0.1), inset 0 1px 0 rgba(255,255,255,0.06)";
      },
      onMouseLeave: (e) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(StarRow, { size: 13 })
            ]
          }
        )
      ]
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute top-0 left-0 right-0 h-px",
            style: {
              background: "linear-gradient(90deg, transparent, rgba(124,58,237,0.35), rgba(0,188,212,0.35), transparent)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h2",
            {
              ...
              children: [
                ...
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Yashraj Dance Studio" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 mb-14", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "inline-flex flex-col sm:flex-row items-center gap-4 px-8 py-5 rounded-2xl",
                style: {
                  background: "linear-gradient(135deg, rgba(0,188,212,0.07) 0%, rgba(124,58,237,0.07) 100%)",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl font-black font-display gradient-text leading-none", children: "4.9" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center sm:items-start gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(StarRow, { size: 22 }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "#8a8a8a" },
                children: "What this really means: people consistently love the teaching style, energy, and comfort level here."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6", children: firstRow.map((review) => /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCard, { review }, review.id)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col md:flex-row justify-center gap-6 md:max-w-2xl lg:max-w-3xl mx-auto", children: secondRow.map((review) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 md:max-w-sm lg:max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCard, { review }) }, review.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-12", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading mb-4", style: { color: "#ffffff" }, children: [
              "Who It's ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "For" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#a0a0a0" }, children: "Our studio welcomes people from all walks of life. No experience needed — just a desire to move and grow." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4", children: AUDIENCE.map(({ emoji, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhoItsForSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TeachingApproachSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(HighlightsSection, {}),
